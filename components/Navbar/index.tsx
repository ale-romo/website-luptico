...
const Navbar = ({ navItems }: Props) => {
  ...
  return <div className="w-full flex p-2 justify-between items-center bg-no-repeat bg-contain px-3 sm:px-8 lg:px-20 pt-5 bg-gradient-to-b from-white to-transparent from-50%">
